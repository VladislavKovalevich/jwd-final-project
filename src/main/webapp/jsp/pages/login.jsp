    ...
    <div class="col mb-3">
        <form action="controller">
            ...
            <div class="form-outline mb-4">
                ...
                <input type="text" name="email" id="email" class="form-control" value="${user_form_data['email_form']}"/>
            </div>

            <div class="form-outline mb-4">
                <label class="form-label" for="password">${password}: </label>
                <input type="password" name="pass" id="password" class="form-control" value="${user_form_data['pass_form']}"/>
            </div>
