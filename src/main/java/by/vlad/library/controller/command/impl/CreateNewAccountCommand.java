...
public class CreateNewAccountCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) throws CommandException {
        ...
        cleanWrongMessages(userData);
        fillUserDataMap(request, userData);
        ...
        try {
            if(userService.createNewAccount(userData)){
                ...
                router = new Router(MAIN_PAGE, Router.Type.FORWARD);
            }else{
    ...
    private void fillUserDataMap(HttpServletRequest request, Map<String, String> userFormData){
