...
import static by.vlad.library.controller.command.PagePath.ORDERS_LIST_BY_USER_ID;
...
public class GetOrdersByUserIdCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) throws CommandException {
        ...
        try {
            ...
            session.setAttribute(CURRENT_PAGE, ORDERS_LIST_BY_USER_ID);
        } catch (ServiceException e) {
            throw new CommandException(e);
        }

        return new Router(PagePath.ORDERS_LIST_BY_USER_ID, Router.Type.FORWARD);
    }
}
