...
public class AttributeAndParamsNames {
    ...
    public static final String NEW_PUBLISHER_CHECK_FORM = "new_publisher_check_form";
    public static final String NEW_AUTHOR_CHECK_FORM = "new_author_check_form";
    public static final String NEW_AUTHOR_NAME_FORM = "new_author_name_form";
    public static final String NEW_AUTHOR_SURNAME_FORM = "new_author_surname_form";
    public static final String NEW_PUBLISHER_NAME_FORM = "new_publisher_name_form";

    public static final String WRONG_TITLE_FORM = "wrong_title_form";
    public static final String WRONG_AUTHOR_FORM = "wrong_author_form";
    ...
    public static final String WRONG_PUBLISHER_FORM = "wrong_publisher_form";
    public static final String WRONG_DESCRIPTION_FORM = "wrong_description_form";
    public static final String WRONG_NEW_AUTHOR_NAME_FORM = "wrong_new_author_name_form";
    public static final String WRONG_NEW_AUTHOR_SURNAME_FORM = "wrong_new_author_surname_form";
    public static final String WRONG_NEW_PUBLISHER_NAME_FORM = "wrong_new_publisher_name_form";
    ...
    public static final String NEW_PUBLISHER_CHECK = "new_publisher_check";
    public static final String NEW_AUTHOR_CHECK = "new_author_check";
    public static final String NEW_AUTHOR_NAME = "new_author_name";
    public static final String NEW_AUTHOR_SURNAME = "new_author_surname";
    public static final String NEW_PUBLISHER_NAME = "new_publisher_name";
